...
//        item.getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (localeInfo != null) {
                    Setting.SetLanguageSelected(true); // Adel
    ...
    private void fillLanguages() {
        ...
        Collections.sort(sortedLanguages, new Comparator<LocaleController.LocaleInfo>() {
            @Override
            public int compare(LocaleController.LocaleInfo o1, LocaleController.LocaleInfo o2) {
                if (o1 == currentLocale) {
                    return -1;
                } else if (o2 == currentLocale) {
                    return 1;
                }
                if (o1.shortName.equals("fa"))
                    return -1;
                else if (o2.shortName.equals("fa"))
                    return 1;
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            //Sajjad: I changed the below code so that no language will be selected at the first launch
//            textSettingsCell.setLanguageSelected(localeInfo == LocaleController.getInstance().getCurrentLocaleInfo());
            textSettingsCell.setLanguageSelected(false);
        }
