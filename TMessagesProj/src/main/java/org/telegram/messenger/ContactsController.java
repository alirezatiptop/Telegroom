...
public class ContactsController {
	...
	public ArrayList<String> onlineSortedUsersSectionsArray; // Adel
	public HashMap<String, ArrayList<TLRPC.TL_contact>> onlineUsersSectionsDict; // Adel
    ...
    public void checkInviteText() {
        ...
        if (true)
        {
            inviteText = LocaleController.getString("InviteText", R.string.InviteText);
            return;
        }
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
...
//        return inviteText != null ? inviteText : LocaleController.getString("InviteText", R.string.InviteText);
        return inviteText = LocaleController.getString("InviteText", R.string.InviteText); // Adel
    }
