...
public class MessagesStorage {
    ...
    //Sajjad, to use in editing messages
    public  ArrayList<TLRPC.Message> getMyMessage(final long dialog_id, final int count, final int max_id, final int offset_date, final int minDate, final int classGuid, final int load_type, final boolean isChannel, final int loadIndex) {
